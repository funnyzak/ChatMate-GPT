...
import { Typography } from '@src/types'
import { Platform } from 'react-native'
import blackTypographys from '../black/typography'
...
const titleTextColor = colors.primaryText
const bodyTextColor = colors.primaryText
const captionTextColor = colors.placeholderText
